...
const ServiceCard = ({ name, image }) => {
    return (
        <div className=" w-full rounded-xl flex flex-row justify-between lg:pb-[28px]  bg-white shadow-[0px_4px_16px_rgba(2,110,192,0.18)] transition-all duration-300 ease-in-out hover:shadow-[0px_8px_24px_rgba(2,110,192,0.25)] hover:-translate-y-1">
